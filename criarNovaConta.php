...
<html lang="en">
  <head>       
    ...
    <title>Loja - Create Account</title>
    <!-- Fonts-->
  ...
  <body class="ps-loading">
        ...
        <form action="cadastroUsuario.php" method="post" class="form-login">
            <label>Nome:</label>
            <input type="text" class="form-control" name="nome" placeholder="Please, insert your username" />
            <label>Usuário:</label>
